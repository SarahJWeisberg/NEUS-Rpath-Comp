...
all_groups <- all_groups %>% mutate(group = ifelse(group == "Seals","Pinnipeds", ifelse(group=="BalWhale","BaleenWhales",ifelse(group=="Seabirds","SeaBirds", ifelse(group=="ToothWhale","Odontocetes",group)))))
...
all_groups %>% 
  mutate(Biomass = ifelse(model=="GB",Biomass/4,Biomass)) %>%
...
##4.2 Network conversion of GOM ecosense outputs
