...
#GOM diet
GOM_diet<-as.data.frame(GOM.params$diet)
GOM_diet[is.na(GOM_diet)]<-0
GOM_diet[1:(nliving_GOM+ndead_GOM+1),2:(nliving_GOM+ndead_GOM)]<-GOM_diet[1:(nliving_GOM+ndead_GOM+1),2:(nliving_GOM+ndead_GOM)]*100
...
#GB diet
GB_diet<-as.data.frame(GB.params$diet)
GB_diet[is.na(GB_diet)]<-0
GB_diet[1:(nliving_GB+ndead_GB+1),2:(nliving_GB+ndead_GB)]<-GB_diet[1:(nliving_GB+ndead_GB+1),2:(nliving_GB+ndead_GB)]*100
...
#MAB diet
MAB_diet<-as.data.frame(MAB.rpath.params$diet)
MAB_diet[is.na(MAB_diet)]<-0
MAB_diet[1:(nliving_MAB+ndead_MAB+1),2:(nliving_MAB+ndead_MAB)]<-MAB_diet[1:(nliving_MAB+ndead_MAB+1),2:(nliving_MAB+ndead_MAB)]*100
