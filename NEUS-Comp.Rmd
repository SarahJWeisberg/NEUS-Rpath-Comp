...
Figure_4<-ASC_CAP %>% filter(condition == "plausible") %>%
  ...
  geom_hline(yintercept = 0.36,color=my.pal2[3],linetype="dashed",linewidth=0.75)+
  geom_hline(yintercept = 0.44,color=my.pal2[3],linetype="dashed",linewidth=0.75)+
...
ggsave(filename = "Fig4.jpg",Figure_4,width=7.5,height = 8,dpi = 300)
```
